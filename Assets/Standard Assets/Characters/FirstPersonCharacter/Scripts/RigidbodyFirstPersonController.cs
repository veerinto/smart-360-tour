...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        {
            public float ForwardSpeed = .1f;   // Speed when walking forward
            public float BackwardSpeed = 1f;  // Speed when walking backwards
            public float StrafeSpeed = 05.0f;    // Speed when walking sideways
            public float RunMultiplier = .5f;   // Speed when sprinting
